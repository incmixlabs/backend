...
flyctl deploy --config ./deployment/prod/fly.incmix-auth.toml 2>&1 | sed 's/^/[auth] /' &
flyctl deploy --config ./deployment/prod/fly.incmix-bff-web.toml 2>&1 | sed 's/^/[bff-web] /' &
flyctl deploy --config ./deployment/prod/fly.incmix-intl.toml 2>&1 | sed 's/^/[intl] /' &
flyctl deploy --config ./deployment/prod/fly.incmix-email.toml 2>&1 | sed 's/^/[email] /' &
flyctl deploy --config ./deployment/prod/fly.incmix-files.toml 2>&1 | sed 's/^/[files] /' &
flyctl deploy --config ./deployment/prod/fly.incmix-location.toml 2>&1 | sed 's/^/[location] /' &
flyctl deploy --config ./deployment/prod/fly.incmix-org.toml 2>&1 | sed 's/^/[org] /' &
flyctl deploy --config ./deployment/prod/fly.incmix-tasks.toml 2>&1 | sed 's/^/[tasks] /' &
flyctl deploy --config ./deployment/prod/fly.incmix-users.toml 2>&1 | sed 's/^/[users] /' &
