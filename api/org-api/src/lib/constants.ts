...
export const ERROR_ORG_EXIST = { namespace: "errors", key: "org_exist" } as const
export const ERROR_ORG_NOT_FOUND = {
  namespace: "errors",
  key: "org_not_found",
} as const
export const ERROR_NO_ROLES = { namespace: "errors", key: "role_not_found" } as const
...
export const ERROR_INVALID_USER = { namespace: "errors", key: "invalid_user" } as const
export const ERROR_NOT_MEMBER = { namespace: "errors", key: "not_member" } as const
export const ERROR_MEMBER_EXIST = { namespace: "errors", key: "member_exist" } as const
